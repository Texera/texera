...
export class CardItemComponent implements OnChanges {
  ...
  /** The hover controls over the cover: image controls for the owner, the default-view toggle for a writer. */
  get hasCoverControls(): boolean {
    return this.canEditCover || this.canToggleDefaultView;
  }
