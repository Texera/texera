...
import edu.uci.ics.texera.workflow.operators.test.{TestAOpDesc, TestBOpDesc}
...
@JsonSubTypes(
  Array(
    ...
    new Type(value = classOf[TestAOpDesc], name = "TestA"),
    new Type(value = classOf[TestBOpDesc], name = "TestB"),
