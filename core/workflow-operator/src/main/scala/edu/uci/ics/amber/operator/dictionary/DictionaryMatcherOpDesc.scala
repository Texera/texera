  ...
  override def getPhysicalOp(
    ...
    PhysicalOp
      .oneToOnePhysicalOp(
        ...
        executionId,
        operatorIdentifier,
        OpExecInitInfo((_, _) => ExecFactory.newExecFromJavaClassName("edu.uci.ics.amber.operator.dictionary.DictionaryMatcherOpExec", objectMapper.writeValueAsString(this)))
      )
